...
@pytest.mark.parametrize(
    "start, finish, result",
    [(1, 3, "0000 0000 0000 0001"), (2, 4, "0000 0000 0000 0002"), (10, 12, "0000 0000 0000 0010")],
)
def test_card_number_generator(start, finish, result):
    generator_card = card_number_generator(start, finish)
